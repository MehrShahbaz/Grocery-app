...
RSpec.describe '/manufacturers', type: :request do
  ...
  # ManufacturersController, or in your router and rack
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ...
      get manufacturers_url, headers: valid_headers, as: :json
  ...
  describe 'POST /create' do
      ...
      it 'creates a new Manufacturer' do
        expect do
          post manufacturers_url,
               params: { manufacturer: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      it 'does not create a new Manufacturer' do
        expect do
          post manufacturers_url,
               params: { manufacturer: invalid_attributes }, as: :json
        end.to change(Manufacturer, :count).by(0)
      end

      it 'renders a JSON response with errors for the new manufacturer' do
        post manufacturers_url,
             params: { manufacturer: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with valid parameters' do
      ...
      it 'updates the requested manufacturer' do
        ...
        patch manufacturer_url(manufacturer),
              params: { manufacturer: new_attributes }, headers: valid_headers, as: :json
        manufacturer.reload
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested manufacturer' do
      manufacturer = Manufacturer.create! valid_attributes
      expect do
        delete manufacturer_url(manufacturer), headers: valid_headers, as: :json
      end.to change(Manufacturer, :count).by(-1)
    end
  end
end
